...
typedef struct {
	...
	unsigned short infinite_keep_alive_requests;
...
typedef struct server {
	...
	int listen_backlog;
#else
	/* use to hold a pointer that tells that this is the first entry */
	/* this identifier field will be used to create server socket for */
	/* only the first element of the array */
	struct server *first_entry;
#endif
#endif
	uid_t uid;
	gid_t gid;
