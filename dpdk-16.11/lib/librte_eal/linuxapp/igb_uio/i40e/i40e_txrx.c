 ...
 * @skb: skb to use, or NULL to allocate one
 *
 * This function allocates an skb if the skb arg is NULL.  It then
 * populates it with the page data from the current receive
